    ...
    convertValueToResult: (quizValue) => {
        ...
        if (quizValue >= 80) {
            ...
            // answerObject.imagePath = image1
             ...
             answer = " HMM, not your best day today huh? that's ok, you know what would be awesome? cuddling! You know how you can make your cuddling experience better? being little spoon... yeah that's right, let your partner wrap their arms around you. Let yourself be vulnerable and accept your partner's love!";
        } else {
